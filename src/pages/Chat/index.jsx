...
const Chat = ({ match, history }) => {
	...
	const submitNewMessage = () => {
		addNewMessage(user._id, newMessage);
		setNewMessage("");
		scrollToLastMsg();
	};

	// const setUserDoTyping = () => {
	// 	setUserAsTyping({userId:LoggedIn_user.userId});
	// };
			...
			<div className="chat__body">
				...
				<footer className="chat__footer">
					...
					<ChatInput
						...
						// setUserDoTyping={setUserDoTyping}
					/>
				</footer>
			</div>
			<ChatSidebar
